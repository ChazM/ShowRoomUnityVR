...
public enum GrabType{   Snap, Precise }
...
public enum OtherGrabBehavior { None, SwapHands, DualGrab }

/// <summary>
/// An steering wheel object that can be picked up by a Grabber
/// </summary>
public class GrabbableSteeringWheel : MonoBehaviour {



    [HideInInspector]
        public bool BeingHeld = false;
        List<BNG.Grabber> validGrabbers;
        ...
        public GrabbableSteeringWheel SecondaryGrabbable;
        ...
        void Update()
        {
            ...
            if (remoteGrabbing)
            {
                ...
                if (dist <= 0.002f)
                {
                    ...
                    if (flyingTo != null)
                    {
                        flyingTo.GrabGrabbableSpecial(this);
                    }
                }
